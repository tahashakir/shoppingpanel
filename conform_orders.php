                        ...
                        <div class="heading-layout1">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item" href="conform_orders.php"><i
...
<nav aria-label="Page navigation example" class="float-left">
  <ul class="pagination">
    <li class="page-item"><a class="page-link" href="conform-orders.php?page=<?= $Previous; ?>" >Previous</a></li>
    <?php for($i = 1; $i<= $pages; $i++) : ?>
    <li class="page-item"><a href="conform-orders.php?page=<?= $i; ?>" class="page-link"><?= $i; ?></a></li>
    <?php endfor; ?>
    <li class="page-item"><a href="conform-orders.php?page=<?= $Next; ?>" class="page-link">Next</a></li>
  </ul>
</nav>
...
<td><?=$n?></td>
    ...
    <td><a href="myphp.php?unconfirm_order=yes&id=<?=$customer['id']?>">
...
$(document).ready(function(){
    $('.search-box input[type="text"]').on("keyup input", function(){
        ...
        if(inputVal.length){
            $.get("search-orders.php", {most: inputVal}).done(function(data){
